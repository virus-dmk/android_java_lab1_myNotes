...
import by.bychko.notelist.utils.getNotesSortMethodName
import by.bychko.notelist.utils.setNotesSortMethod
...
class MainPresenter : MvpPresenter<MainView>() {
    ...
    fun search(query: String) {
        if (query == "") {
            ...
            val searchResults = notesList.filter { it.text!!.contains("#${query}", ignoreCase = true) }
    ...
    fun showDevInfo(info:String) {
        viewState.showNoteInfoDialog(info)
    }
